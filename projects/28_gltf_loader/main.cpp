...
private:
    void SetupEntity(const Geometry* geo, const GeometryOptions& createInfo, Entity* pEntity);
};

void ProjApp::Config(ppx::ApplicationSettings& settings)
{
    settings.appName                    = "28_gltf_loader";
...
void ProjApp::SetupEntity(const Geometry* geo, const GeometryOptions& createInfo, Entity* pEntity)
{
